  ...
  <LandingContainer>
    <header class="flex flex-col lg:flex-row justify-between items-center my-5">
      <div class="flex w-full lg:w-auto items-center justify-between">
        <a href="/" class="text-3xl"><span class="font-bold text-[#00ADEF]">inclusiva</span><span
            class="font-bold text-[#00A54F]">360</span>
        </a>
      ...
      <nav class="w-full lg:w-auto mt-2 lg:flex lg:mt-0" :class="{ block: open, hidden: !open }">
        ...
        <div class="lg:hidden flex items-center mt-3 gap-4">
          <LandingLink href="/contact" size="md" block>Sign up</LandingLink>
        </div>
      </nav>
      <div>
        <div class="hidden lg:flex items-center gap-4">
          <LandingLink href="/contact" size="md">Quero colaborar</LandingLink>
        </div>
      </div>
    </header>
  </LandingContainer>
